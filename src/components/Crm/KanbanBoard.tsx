...
function KanbanColumn({ col, leads }: { col: typeof COLUMNS[0], leads: Lead[] }) {
    ...
    const totalValue = leads.length * 1500; // Mock value calculation
    ...
    return (
        ...
        >
            ...
            <div className="flex justify-between items-start mb-2">
                ...
                <p className="text-[10px] text-slate-500 whitespace-nowrap">Jan 30</p>
            </div>
            ...
            <div className="flex items-center justify-between mt-2 pt-2 border-t border-slate-800">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <div className="w-5 h-5 rounded-full bg-indigo-950 text-indigo-400 flex items-center justify-center text-[9px] font-bold border border-indigo-900">
                        JD
                    </div>
                </div>
            </div>
